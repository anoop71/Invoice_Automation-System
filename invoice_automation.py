...
def generate_invoice(customer_id, product_ids, quantities):
	...
	pdf.cell(200, 10, txt="Tanwar Pvt Ltd.", ln=True)
	pdf.cell(200, 10, txt="Haryana, India", ln=True)
	pdf.cell(200, 10, txt="Pincode: 123034", ln=True)
	pdf.cell(200, 10, txt="Email: mail.anooptanwar12345@gmail.com", ln=True)
